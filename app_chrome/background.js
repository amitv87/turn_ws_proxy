...
const DEFAULT_MAX_CONNECTIONS=99;
...
(function(exports) {
  ...
  TcpConnection.prototype.getSocketInfo = function(callback) {
  ...
  TcpConnection.prototype._onReceive = function(info) {
    ...
    if (this.callbacks.recv) {
      ...
      this.callbacks.recv.bind(this)(info.data)
    }
  };
